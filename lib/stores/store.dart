...
class QuizStore {
  ...
  final String rewardJsonFileName = "assets/data/reward.json";
  ...
  Future<List<Reward>> loadRewardsAsync() async {
    List<Reward> rewardList = [];
    rewardList = await JsonUtil.loadFromJsonAsync<Reward>(
        rewardJsonFileName, Reward.jsonToObject);
    return rewardList;
  }
